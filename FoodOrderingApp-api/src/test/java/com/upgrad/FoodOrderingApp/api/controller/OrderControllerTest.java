...
public class OrderControllerTest {
    ...
    public void shouldGetPlacedOrderDetails() throws Exception {
        ...
        assertEquals(customerOrderResponse.getOrders().get(0).getId().toString(), orderEntity.getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getCustomer().getId().toString(), orderEntity.getCustomerId().getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getId().toString(), orderEntity.getAddressId().getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getState().getId().toString(), orderEntity.getAddressId().getStateEntityId().getUuid());
    ...
    private OrderEntity getOrderEntity(final CustomerEntity customerEntity) {
        ...
        restaurantEntity.setAddressId(addressEntity);
