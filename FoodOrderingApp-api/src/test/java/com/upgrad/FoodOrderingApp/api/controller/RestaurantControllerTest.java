...
public class RestaurantControllerTest {
    ...
    public void shouldGetRestaurantDetailsByGivenName() throws Exception {
        ...
        assertEquals(restaurantList.getAddress().getId().toString(), restaurantEntity.getAddressId().getUuid());
        assertEquals(restaurantList.getAddress().getState().getId().toString(), restaurantEntity.getAddressId().getStateEntityId().getUuid());
